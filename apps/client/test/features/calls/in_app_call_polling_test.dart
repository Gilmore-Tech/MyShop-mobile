...
import 'package:myshop_client/src/features/calls/screens/in_app_call_screen.dart';
...
void main() {
  testWidgets('client call refresh timer does not overlap a slow initial join',
      (tester) async {
    ...
    await tester.pumpWidget(
      ProviderScope(
        ...
        child: const MaterialApp(
          home: ClientInAppCallScreen(callId: 'call-1'),
        ),
      ),
    );
