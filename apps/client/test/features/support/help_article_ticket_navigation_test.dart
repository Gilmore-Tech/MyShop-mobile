...
import 'package:myshop_client/src/features/support/screens/help_article_route_screen.dart';
  ...
  testWidgets('help article opens the new-ticket route instead of popping', (
    ...
    final router = GoRouter(
      ...
      routes: [
        ...
        GoRoute(
          path: '/profile/support/tickets/new',
          builder: (_, state) => Scaffold(
            key: const ValueKey('client-new-ticket-route'),
            body: Text(
    ...
    expect(
        find.byKey(const ValueKey('client-new-ticket-route')), findsOneWidget);
