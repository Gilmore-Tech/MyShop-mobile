      ...
      body: ListView(
        children: [
          ...
          _Section(label: 'RIDE FLOW', color: MyShopColors.info, children: [
            _Tile('Destination Search',
                () => context.push(AppRoutes.rideSearchPath('destination'))),
            _Tile('Map Pin Picker',
                () => context.push(AppRoutes.ridePinPickerPath('destination'))),
            _Tile('Fare Estimate / Plan Trip',
                () => context.push(AppRoutes.rideEstimate)),
            _Tile('Add Stop', () => context.push(AppRoutes.rideStops)),
            _Tile(
                'Driver Matching', () => context.push(AppRoutes.rideMatching)),
            _Tile(
                'Driver Found',
                () => context.push(AppRoutes.rideDriverFound,
                    extra: _mockDriver)),
            _Tile('Ride Tracking',
                () => context.push(AppRoutes.rideTracking, extra: _mockDriver)),
            _Tile('Ride Complete', () => context.push(AppRoutes.rideComplete)),
            _Tile('Ride Receipt',
                () => context.push(AppRoutes.rideReceiptPath(_mockRideId))),
            _Tile('Ride Dispute',
                () => context.push(AppRoutes.rideDisputePath(_mockRideId))),
          ]),
          ...
          _Section(
              ...
              children: [
                _Tile(
                    'Job Form (New Job)', () => context.push(AppRoutes.jobNew)),
                _Tile('Job Detail',
                    () => context.push(AppRoutes.jobDetailPath(_mockJobId))),
                _Tile(
                    'Bid Detail',
                    () => context
                        .push(AppRoutes.jobBidsPath(_mockJobId, _mockBidId))),
                _Tile(
                    'Bid Review',
                    () => context.push(AppRoutes.jobBidReviewPath(_mockJobId),
                        extra: _mockBidId)),
                _Tile(
                    'Supplement Review',
                    () =>
                        context.push(AppRoutes.jobSupplementPath(_mockJobId))),
                _Tile('Active Job',
                    () => context.push(AppRoutes.jobActivePath(_mockJobId))),
                _Tile('Job Tracking',
                    () => context.push(AppRoutes.jobTrackingPath(_mockJobId))),
                _Tile('Job Summary',
                    () => context.push(AppRoutes.jobSummaryPath(_mockJobId))),
                _Tile('Job Complete / Rate',
                    () => context.push(AppRoutes.jobCompletePath(_mockJobId))),
                _Tile('Job Receipt',
                    () => context.push(AppRoutes.jobReceiptPath(_mockJobId))),
                _Tile('Job Dispute',
                    () => context.push(AppRoutes.jobDisputePath(_mockJobId))),
                _Tile('Payment',
                    () => context.push(AppRoutes.jobPaymentPath(_mockJobId))),
              ]),
          ...
          _Section(
              ...
              children: [
                ...
                _Tile(
                    'Ride History Detail',
                    () =>
                        context.push(AppRoutes.activityRidePath(_mockRideId))),
                _Tile('Job History Detail',
                    () => context.push(AppRoutes.activityJobPath(_mockJobId))),
              ]),
          ...
          _Section(
              ...
              children: [
                ...
                _Tile(
                    'Edit Profile', () => context.push(AppRoutes.profileEdit)),
                _Tile('Saved Locations',
                    () => context.push(AppRoutes.profileSavedPlaces)),
                _Tile('Privacy & Security',
                    () => context.push(AppRoutes.profilePrivacy)),
                _Tile('App Preferences',
                    () => context.push(AppRoutes.profilePreferences)),
                _Tile('Support & Legal',
                    () => context.push(AppRoutes.profileSupport)),
                _Tile(
                    'Referral', () => context.push(AppRoutes.profileReferral)),
                _Tile('Payment Methods',
                    () => context.push(AppRoutes.profilePayments)),
                _Tile('Emergency Contacts',
                    () => context.push(AppRoutes.profileEmergency)),
                _Tile('Loyalty Points',
                    () => context.push(AppRoutes.profileLoyalty)),
              ]),
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Padding(
          padding:
              EdgeInsets.fromLTRB(w * 0.041, w * 0.051, w * 0.041, w * 0.021),
          child: Row(
            children: [
              Container(
                width: w * 0.010,
