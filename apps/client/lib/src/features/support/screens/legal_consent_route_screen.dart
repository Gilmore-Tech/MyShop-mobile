...
class _LegalConsentRouteScreenState
  ...
  Widget build(BuildContext context) {
    ...
    final currentIdentity =
        ref.watch(clientRoleSessionIdentityProvider).valueOrNull;
  ...
  Future<void> _accept(List<LegalAcceptanceSelection> acceptances) async {
    final owner = ref.read(clientRoleSessionIdentityProvider).valueOrNull;
  ...
  RoleSessionIdentity? _currentIdentity() =>
      ref.read(clientRoleSessionIdentityProvider).valueOrNull;
