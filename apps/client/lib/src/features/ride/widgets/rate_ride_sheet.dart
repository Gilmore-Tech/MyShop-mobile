...
///
/// Decoupled from any specific receipt shape — both the post-completion
/// flow (`RideReceipt`) and the receipt-screen flow (`RideReceiptData`)
/// just need to hand us the rideId and the driver's first name.
///
        ...
        child: Column(
          ...
          children: [
            ...
            _NoteInput(
              ...
              driverFirstName: widget.driverFirstName,
              onChanged: (t) =>
